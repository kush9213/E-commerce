    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-body">
                ...
                <form class="form-horizontal" action="<?= base_url(); ?>index.php/edit_advertisement" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="date" value="<?php echo date("d-m-y"); ?> ">
                    <input type="hidden" name="advertisement_id" value="<?php echo $class['advertisement_id'];?>">
                        ...
                        <div class="col-4">
                            ...
                            <select class="custom-select col-12" id="category_id" name="category_id">
                                ...
                                <?php if (!empty($fetch_category)) {
                                    foreach ($fetch_category as $classs) { ?>
                                        <option value="<?php echo $classs->category_id; ?> ">
                                            <?php echo $classs->category_name; ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <input class="form-control" type="text" placeholder="Enter Name" value="<?php echo $class['name'];?>" name="name">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                        <textarea class="form-control" name="description" rows="5"><?php echo $class['description'];?> </textarea>
