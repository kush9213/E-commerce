    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <!-- This is  -->
                        <li class="nav-item hidden-sm-up"> <a class="nav-link nav-toggler waves-effect waves-light" href="<?php echo base_url(); ?>javascript:void(0)"><i class="ti-menu"></i></a></li>
                        <li class="nav-item d-none d-lg-block"><a class="nav-link nav-lock waves-effect waves-light" href="<?php echo base_url(); ?>javascript:void(0)"><i class="ti-menu"></i></a></li>
                        <!-- ============================================================== -->
                        <!-- Comment -->
                        <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url(); ?>javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="p-l-30 p-10"><a href="<?php echo base_url(); ?>javascript:void(0)" class="btn btn-sm btn-success btn-rounded">View Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
        ...
        <aside class="left-sidebar">
            <div class="d-flex no-block nav-text-box align-items-center">
                ...
                <a class="nav-lock waves-effect waves-dark ml-auto hidden-md-down" href="<?php echo base_url(); ?>javascript:void(0)"><i class="mdi mdi-toggle-switch"></i></a>
                <a class="nav-toggler waves-effect waves-dark ml-auto hidden-sm-up" href="<?php echo base_url(); ?>javascript:void(0)"><i class="ti-menu ti-close"></i></a>
            </div>
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar ps-container ps-theme-default" data-ps-id="0afe7b82-b1cf-4826-9dbe-d89b54770708">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark active" href="<?php echo base_url(); ?>javascript:void(0)" aria-expanded="false"><i class="ti-layout-media-right-alt"></i><span class="hide-menu"> Admin</span></a>
                            <ul aria-expanded="false" class="collapse in">
                                <li><a href="<?= base_url(); ?>index.php/view_admin ">Update Data<i class="ti-file"></i></a></li>
                                <li><a href="<?= base_url(); ?>index.php/advertisement">Add Advertisement<i class="ti-files"></i></a></li>
