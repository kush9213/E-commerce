    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title"> <a href="<?php echo base_url(); ?>index.php/add_sub_category"> <button type="button" class="btn waves-effect waves-light btn-rounded btn-info"> Add </button></a>
            </h4>
            <h4 class="card-subtitle">Sub Category</h4>
                                                ...
                                                <table id="config-table" class="table display table-bordered table-striped no-wrap dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="config-table_info" style="width: 1007px;">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="config-table" rowspan="1" colspan="1" style="width: 77px;" aria-label="Last name: activate to sort column ascending">Sub Category Name</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a class="detail-icon" href="<?php echo base_url(); ?>index.php/get_sub_category?sub_category_id=<?php echo $class->sub_category_id; ?>"> <i class="fa fas fa-plus-circle"></i> </a>
                                                                
                                                            <a class="remove" href="<?php echo base_url(); ?>index.php/delete_sub_category?sub_category_id=<?php echo $class->sub_category_id; ?>" onclick="return confirm('Are you sure ?')" class="on-default remove-row"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php }
                                                            } else {  ?>
